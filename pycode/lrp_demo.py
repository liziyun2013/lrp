...
for i in range(len(X)):
    ...
    hm_label = render.hm_to_rgb(R, X = x, scaling = 3, sigma = 2)
    hm_all = render.hm_to_rgb(R_all, X = x, scaling = 3, sigma = 2)
    digit_hm = render.save_image([hm_label, hm_all],img_dir+str(i)+'.jpg')
    data_io.write([R, R_all],data_dir+str(i)+'.npy')
